...
$(function () {
    var _sideBar = '<nav class="navbar navbar-default" role="navigation">' +
        ...
        '</a>' +
        '</li>' +
        '<li class="gongsi_tongzhi">' +
        '<a href="../gongsi_tongzhi/gongsi_tongzhi.html">' +
        '<span class="icon fa fa-group"></span><span class="title">公司通知</span>' +
        '</a>' +
        '</li>' +
        ...
        '</li>' +
        '<li class="wode_renwu flag3">' +
        '<a href="../wode_renwu/yue_kaohe_detail.html">' +
        '<span class="icon fa fa-align-center"></span><span class="title">月考核</span>' +
        '</a>' +
        '</li>'+
        ...
        '<div class="panel-body">' +
        '<ul class="nav navbar-nav">' +
        '<li  class="meiri_renwu_jiancha2"><a href="../kaohe/renwu_jiancha.html">每日任务</a></li>' +
        '<li  class="meiri_renwu_jiancha1"><a href="../kaohe/renwu_jiancha1.html">每日任务</a></li>' +
        ...
        '<li class="flag3 yeji_renwu_jiancha"><a href="../wode_renwu/chuzheng_renwu.html">初诊任务</a>'+
        ...
        '</a>' +
        '</li>' +
        '<li class="panel panel-collapse dropdown zhaopin_renwu">' +
        '<a data-toggle="collapse" href="#zhaopin_renwu">' +
        '<span class="icon fa fa-binoculars"></span><span class="title">招聘任务</span>' +
        '</a>' +
        '<div id="zhaopin_renwu" class="panel-collapse collapse">' +
        '<div class="panel-body">' +
        '<ul class="nav navbar-nav">' +
        '<li  class="zhaopin_tianjia"><a href="../xinxi_guanli/zhaopin.html">添加招聘信息</a></li>' +
        '<li  class="zhaopin_liebiao"><a href="../xinxi_guanli/wode_zhaopin.html">招聘列表</a></li>' +
        '</ul>' +
        '</div>' +
        '</div>' +
        '</li>' +
        ...
        '<li><a href="../tianjia_yeji/men_zheng.html">门诊业绩</a></li>' +
        '</ul>' +
        '</div>' +
        '</div>' +
        '</li>' +
        ...
        '</a>' +
        '</li>' +
        '<li class="jiebang flag3">' +
        '<a href="../zuyuan_guanli/zuyuan_guanli.html">' +
        '<span class="icon fa fa-users"></span><span class="title">解绑微信</span>' +
        '</a>' +
        '</li>' +
        '<li class="kaohe">' +
        ...
        '<li><a href="../pai_hang_bang/teamRankList.html">战区排行榜</a></li>' +
        ...
        '<li><a href="../pai_hang_bang/withdrawRankList.html">提现排行榜</a></li>' +
        '</ul>' +
        '</div>' +
        '</div>' +
        '</li>'+
...
//鉴权
    ...
    if(roleId == "1") {
        ...
        $(".lable1").attr("href","../gongzuo_zongjie/jingli_tianjia.html");
    }
    if(roleId!=1){
        var teamId = session_login.info.teamId;
        $(".lable1").attr("href","../gongzuo_zongjie/jiancha_list.html?teamId=" + teamId + "&type=member");
    }
    //科长
    ...
    if(session_login.info.roleId != "2") {
        ...
        $(".zhaopin_renwu").css("display","none");
    }
    ...
    if(roleId != "3") {
        ...
        $(".meiri_renwu_jiancha2").css("display","none");
        $(".meiri_renwu_jiancha1").css("display","block");
    }
    ...
    if(roleId == "4"){
        ...
        $(".zhaopin_renwu").css("display","block");
    }
    ...
    if(roleId=="5"){
        ...
        $(".meiri_renwu_jiancha1").css("display","none");
        $(".meiri_renwu_jiancha2").css("display","none");
        $(".notifications").css("display","none");
        $(".yeji_renwu_jiancha").css("display","block");
    ...
    if (roleId == "3") {
        ...
        $(".renwu_jiancha").css("display", "block");
        $(".meiri_renwu_jiancha").css("display","block");
        $(".meiri_renwu_jiancha2").css("display","block");
        $(".meiri_renwu_jiancha1").css("display","none");
        $(".yeji_renwu_jiancha").css("display", "block");
        $(".zhaopin_renwu").css("display","block");
    }
    ...
    if(roleId != "3"){
        //    未读通知
        $.ajax({
            url:config.rootUrl + "user/getUnreadMessage.do",
            data:{
                userId:session_login.info.userId
            },
            async:true,
                    ...
                    setInterval(function() {
                        ...
                        if (isShine == true) {
                            if (/新/.test(title) == false) {
                                ...
                                $(".gongsi_tongzhi").css("backgroundColor","red");
                            } else {
                                document.title = '【　　　　　】';
                                $(".gongsi_tongzhi").css("backgroundColor","");
                            }
                        } else {
                            document.title = titleInit;
                        }
                        $(".gongsi_tongzhi").css("border","red");
                    }, 500);
